...
export function MobileLayout() {
	const { betweenPrices, handleFilterBetweenPrices, handleFilterSearch, productsResponse, searchText, fetchNextPage, hasNextPage } =
		useHomeMobile();
					...
					footer={
						<div className="flex flex-col gap-2 items-center">
							...
							<span className="text-custom-gray">
								...
								<span className="text-custom-gray-dark">{productsResponse.pages?.[0].total}</span> produtos no total
							</span>
						</div>
					}>
