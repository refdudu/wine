  ...
  return (
    <>
      ...
      <main className="mt-4 min-h-96 flex gap-8">
        <div className="flex flex-col gap-2 border-custom-gray-light border max-w-72 w-full uppercase">
          {paymentMethods.map(({ icon: Icon, label, value }) => (
            <div className="border-custom-gray-light text-custom-gray border-b p-4 w-full">
              <RadioInput
                value={value}
